...
Revision ID: 205eb9076408
Revises: 
Create Date: 2026-05-24 01:18:59.479487
...
def upgrade() -> None:
    ...
    sa.Column('greenhouse_id', sa.String(), nullable=True),
    ...
    sa.Column('entry_x', sa.Float(), nullable=False),
    sa.Column('entry_y', sa.Float(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('squares',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('section_id', sa.String(), nullable=False),
    sa.Column('square_number', sa.Integer(), nullable=False),
